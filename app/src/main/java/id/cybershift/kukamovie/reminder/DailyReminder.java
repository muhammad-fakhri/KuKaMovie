...
public class DailyReminder extends BroadcastReceiver {
    ...
    public void setRepeatingAlarm(Context context) {
        ...
        Toast.makeText(context, context.getResources().getString(R.string.set_daily_reminder_success), Toast.LENGTH_SHORT).show();
    }
    ...
    public void cancelAlarm(Context context) {
        ...
        Toast.makeText(context, context.getResources().getString(R.string.set_daily_reminder_off), Toast.LENGTH_SHORT).show();
    }
}
