package id.cybershift.kukamovieconsumerapp.helper;
...
import static id.cybershift.kukamovieconsumerapp.db.DatabaseContract.FavoriteColumns.ID_FROM_API;
import static id.cybershift.kukamovieconsumerapp.db.DatabaseContract.FavoriteColumns.OVERVIEW;
import static id.cybershift.kukamovieconsumerapp.db.DatabaseContract.FavoriteColumns.POSTER;
import static id.cybershift.kukamovieconsumerapp.db.DatabaseContract.FavoriteColumns.RATE;
import static id.cybershift.kukamovieconsumerapp.db.DatabaseContract.FavoriteColumns.TITLE;
import static id.cybershift.kukamovieconsumerapp.db.DatabaseContract.FavoriteColumns.TYPE;
import static id.cybershift.kukamovieconsumerapp.db.DatabaseContract.FavoriteColumns.YEAR;
